...
const Hero = () => {
  return (
    ...
    <div className='relative flex flex-col items-center scroll-smooth'>
      ...
      <div className='text-4xl mt-10'>Hey!</div>
      ...
      <div className='grid gap-4 grid-cols-2 grid-rows-2 w-max mt-5 mb-14'>
      ...
      <div className='flex flex-col items-center w-full mt-5 mb-40'>
        {/* <div className='text-4xl my-5'>About Me</div> */}
        <div className='ease-in delay-1000 bg-[#91EAE4] text-md rounded-xl mx-5 pt-2'>
          <div className='ease-in delay-1000 bg-[#86A8E7] text-md rounded-xl w-full'>
            <div className='ease-in delay-1000 bg-[#2c2f3d] translate-y-2 text-md rounded-xl drop-shadow-2xl w-full p-5 z-10'>
