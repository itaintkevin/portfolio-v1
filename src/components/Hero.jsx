...
const Hero = () => {
  return (
    ...
    <div className='relative flex flex-col items-center'>
      ...
      <div className='absolute left-10 -bottom-8 w-72 h-72 rounded-full mix-blend-screen animate-blob opacity-20 filter blur-3xl bg-[#86A8E7]'></div>
      ...
      <div className='grid gap-4 grid-cols-2 grid-rows-2 w-max my-5'>
        ...
        <a className='flex items-center' href="https://www.instagram.com/it_aint_kevin"><AiOutlineInstagram/>&nbsp;Instagram</a>
      </div>
