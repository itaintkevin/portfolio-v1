...
const Hero = () => {
  return (
    ...
    <div className='relative flex flex-col items-center'>
      <div className='absolute top-0 -left-4 w-72 h-72 rounded-full mix-blend-color-dodge animate-blob opacity-30 filter blur-3xl bg-[#7F7FD5]'></div>
      <div className='absolute top-0 -right-4 w-72 h-72 rounded-full mix-blend-color-dodge animate-blob opacity-30 filter blur-3xl bg-[#91EAE4]'></div>
      <div className='absolute left-10 -bottom-8 w-72 h-72 rounded-full mix-blend-color-dodge animate-blob opacity-30 filter blur-3xl bg-[#86A8E7]'></div>
